...
module.exports = class extends Command {
    ...
    async run(message, [user]) {
        if (!user || !user.bot) return message.channel.send(`Haga ping a un **bot**.`);
        ...
        owners.forEach(o => {
            ...
            o.send(`Tu bot \`${bot.username}\`ha sido verificado.`)
        })
        ...
        message.channel.send(`\`${bot.username}\` ha sido verificado`);
    }
