    ...
    if (location.href.includes("/bots/edit")) {
        ...
        $('#auth').click(() => {
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        title: 'Su token de autorización',
                        icon: 'info',
                        html:
                        `Su token de autorización es <code>${data.auth}</code>`,
                    ...
                    Swal.fire({
                        ...
                        icon: 'error',
                        html:
                        `Hubo un error con su token de autorización..`,
                        showCloseButton: true,
                        focusConfirm: false,
                        confirmButtonText: 'Cerrar',
                        confirmButtonAriaLabel: 'cerrar',
        ...
        $('#reset').click(() => {
            ...
            .then(data => {
                ...
                if (data.success) {
                    Swal.fire({
                        title: 'Tu nuevo token de autorización',
                        icon: 'info',
                        html:
                        `Tu nuevo token de autorización es <code>${data.auth}</code>`,
                        showCloseButton: true,
                        focusConfirm: false,
                        confirmButtonText: 'Cerrar',
                        confirmButtonAriaLabel: 'cerrar',
